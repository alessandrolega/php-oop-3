...
$generi = [
  ...
  'azione' => new Generi('azione', 'icon-font-awesome-fantasy')
];
var_dump($generi);
...
$prodotti = [
  ...
  new Dvd('Fast and Furious 10', 'Universal', 19.99, $generi['azione'], false, 'https://immagine-copertina.com', 130, 2025)
];
